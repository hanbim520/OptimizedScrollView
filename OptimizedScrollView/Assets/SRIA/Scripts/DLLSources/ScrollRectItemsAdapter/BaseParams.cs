...
{
	/// <summary>
	/// <para>Input params to be passed to <see cref="SmartScrollView{TParams, UILoopSmartItem}.Init()"/></para>
   ...
   //     }
		...
		/// <summary>
		/// Called internally in <see cref="SmartScrollView{TParams, UILoopSmartItem}.Init()"/> and every time the scrollview's size changes. 
