...
{
    /// <summary>Required if building for UWP (WSA), but recommended in all cases: Replace your StandaloneInputModule with this one. If you have your own input module, then see <see cref="SmartScrollViewStandaloneInputModule"/></summary>
